      ...
      <div className="container relative z-10 px-4 mx-auto text-center">
        ...
        >
          ...
          >
            <Button 
              size="lg" 
              className="bg-gradient-primary shadow-primary hover:shadow-glow transition-all duration-300 hover:scale-105"
            ...
            <div className="flex gap-3">
              ...
              <Button 
                size="icon" 
                variant="outline"
                className="hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 hover:scale-110"
                asChild
              >
